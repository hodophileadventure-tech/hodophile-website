...
export const NODES: Node[] = [
  ...
  { name: "Lahore", type: "TRANSIT" },
  { name: "Multan", type: "TRANSIT" },
  { name: "Karachi", type: "TRANSIT" },
...
export const EDGES: Edge[] = [
  ...
  { from: "Islamabad", to: "Lahore", distanceKm: 380 },
  { from: "Islamabad", to: "Multan", distanceKm: 680 },
  { from: "Islamabad", to: "Karachi", distanceKm: 1420 },
