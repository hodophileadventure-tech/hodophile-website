...
const sourcePackages: Array<Omit<AdditionalHoneymoonPackage, "title" | "description" | "overview" | "attractions" | "includes" | "excluded" | "bookingPolicy" | "childPolicy" | "mealsMenu" | "detailSections"> & { title: string }> = [
  ...
  { slug: "naran-shogran-luxury-5days", name: "Naran & Shogran Luxury Escape", duration: "5 Days / 4 Nights", detail: "A private luxury journey through Shogran meadows, Naran Valley, Saif-ul-Malook, and Babusar Top.", price: "PKR 245,000", image: "/images/honeymoon/naran-shogran.webp", title: "Naran Shogran Luxury 5 Days" },
  { slug: "naran-kaghan-3days", name: "Naran Kaghan Short Escape", duration: "3 Days / 2 Nights", detail: "A compact couples route covering Naran, Lulusar Lake, Babusar Top, and Saif-ul-Malook.", price: "PKR 80,000", image: "/images/honeymoon/naran-kaghan.webp", title: "Naran Kaghan 3 Days Tour" },
  ...
  { slug: "hunza-naltar-day", name: "Naltar Valley Day Escape", duration: "1 Day", detail: "A private day route from Gilgit to Naltar's colorful lakes, pine forests, and cool mountain air.", price: "PKR 25,000", image: "/images/honeymoon/hunza-gilgit.webp", title: "One Day Naltar Valley Tour" },
...
const packageImageMap: Record<string, string> = {
  ...
  "naran-shogran-luxury-5days": "/images/honeymoon/naran-shogran.webp",
  "naran-kaghan-3days": "/images/honeymoon/naran-kaghan.webp",
  ...
  "hunza-naltar-day": "/images/honeymoon/hunza-gilgit.webp",
