...
// On-route combinations generated by scripts and embedded here for quick validation.
const ON_ROUTE_COMBINATION_KEYS = new Set([
  "Astore",
  "Fairy Meadows",
  "Hunza",
  "Naran",
...
function toCombinationKey(selectedCities: string[]): string {
  return [...new Set(selectedCities)].map((s) => s.trim()).sort((a, b) => a.localeCompare(b)).join(" + ");
}
...
function isValidCombination(selectedCities: string[]): boolean {
  ...
  return ON_ROUTE_COMBINATION_KEYS.has(key);
}
