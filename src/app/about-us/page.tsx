...
export default function AboutUsPage() {
  return (
    <PageShell wide>
      ...
      <section className="mt-12 grid gap-8 lg:grid-cols-[1.15fr_.85fr] lg:items-start mx-auto max-w-[96rem] px-6 lg:px-8 xl:px-10">
      ...
      <section className="mt-16 grid gap-6 md:grid-cols-2 xl:grid-cols-4 mx-auto max-w-[96rem] px-6 lg:px-8 xl:px-10">
