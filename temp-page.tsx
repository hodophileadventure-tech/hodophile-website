          ...
          <div className="relative z-10 mx-auto flex min-h-[82vh] w-full max-w-7xl items-end px-6 pb-16 pt-36 lg:px-8">
            <div className="max-w-4xl text-white">
              <h1 className="font-serif text-4xl leading-[1.05] sm:text-5xl lg:text-6xl">
                Experience Pakistan's Most Cinematic JourneysΓÇöUnforgettably Curated.
              </h1>
              ...
              <div className="text-center">
                ...
                <h2 className="mt-3 font-serif text-4xl leading-tight sm:text-5xl" style={{
                  background: 'linear-gradient(to right, black 50%, #fcc000 50%)',
